...
CREATE TABLE [Book] (
	 ...
	 [Author_m0] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [ApplicationLog] (
 ...
 ALTER TABLE [Tag] ADD CONSTRAINT [Tag_FBook_0] FOREIGN KEY ([Book_m0]) REFERENCES [Book]
CREATE INDEX Tag_IBook_m0 on [Tag] ([Book_m0])

 ALTER TABLE [Book] ADD CONSTRAINT [Book_FAuthor_0] FOREIGN KEY ([Author_m0]) REFERENCES [Author]
CREATE INDEX Book_IAuthor_m0 on [Book] ([Author_m0])
